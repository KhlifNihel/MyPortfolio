        ...
        <React.Fragment>
            <div className={styles.projects}>
                ...
                <section className={styles.projectHeader}>
                    ...
                    <div>My works make use of vast variety of latest technology tools. My best experience is to create Django projects and deploy them to web applications using Github Pages.</div>
                </section>
            </div>
            <ProgrammingSkills />
